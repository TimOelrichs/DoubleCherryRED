...
public:
   ...
   unsigned char getSB() { return (unsigned char) ioamhram_[0x101]; };
   void setSB(unsigned char data) { serialize_value_ = data; };
   unsigned char getSC() { return (unsigned char)ioamhram_[0x102]; };
   void setSC(unsigned char data) { ioamhram_[0x102] = data; };
